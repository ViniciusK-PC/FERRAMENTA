...
<img src="assets/hexstalcke-logo.png" alt="Hex Stalcke AI Logo" width="220" style="margin-bottom: 20px;"/>

# Hex Stalcke AI MCP Agents v6.0
### AI-Powered MCP Cybersecurity Automation Platform

[![Python](https://img.shields.io/badge/Python-3.8%2B-blue.svg)](https://www.python.org/)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Security](https://img.shields.io/badge/Security-Penetration%20Testing-red.svg)](https://github.com/0x4m4/hexstalcke-ai)
[![MCP](https://img.shields.io/badge/MCP-Compatible-purple.svg)](https://github.com/0x4m4/hexstalcke-ai)
[![Version](https://img.shields.io/badge/Version-6.0.0-orange.svg)](https://github.com/0x4m4/hexstalcke-ai/releases)
[![Tools](https://img.shields.io/badge/Security%20Tools-150%2B-brightgreen.svg)](https://github.com/0x4m4/hexstalcke-ai)
[![Agents](https://img.shields.io/badge/AI%20Agents-12%2B-purple.svg)](https://github.com/0x4m4/hexstalcke-ai)
[![Stars](https://img.shields.io/github/stars/0x4m4/hexstalcke-ai?style=social)](https://github.com/0x4m4/hexstalcke-ai)
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://www.linkedin.com/company/hexstalcke-ai">
...
Hex Stalcke AI MCP v6.0 features a multi-agent architecture with autonomous AI agents, intelligent decision-making, and vulnerability intelligence.
...
graph TD
    A[AI Agent - Claude/GPT/Copilot] -->|MCP Protocol| B[Hex Stalcke MCP Server v6.0]
...
### Quick Setup to Run the hexstalcke MCPs Server

```bash
# 1. Clone the repository
git clone https://github.com/0x4m4/hexstalcke-ai.git
cd hexstalcke-ai

# 2. Create virtual environment
python3 -m venv hexstalcke-env
source hexstalcke-env/bin/activate  # Linux/Mac
# hexstalcke-env\Scripts\activate   # Windows
...
Watch the full installation and setup walkthrough here: [YouTube - Hex Stalcke AI Installation & Demo](https://www.youtube.com/watch?v=pSoftCagCm8)

#### Supported AI Clients for Running & Integration

You can install and run Hex Stalcke AI MCPs with various AI clients, including:
...
python3 hexstalcke_server.py --debug

# Optional: Custom port configuration
python3 hexstalcke_server.py --port 8888
```
...
```json
{
  "mcpServers": {
    "hexstalcke-ai": {
      "command": "python3",
      "args": [
        "/path/to/hexstalcke-ai/hexstalcke_mcp.py",
        "--server",
        "http://localhost:8888"
      ],
      "description": "Hex Stalcke AI v6.0 - Advanced Cybersecurity Automation Platform",
      "timeout": 300,
      "disabled": false
    }
  }
...
## Usage Examples
When writing your prompt, you generally can't start with just a simple "i want you to penetration test site X.com" as the LLM's are generally setup with some level of ethics. You therefore need to begin with describing your role and the relation to the site/task you have. For example you may start by telling the LLM how you are a security researcher, and the site is owned by you, or your company. You then also need to say you would like it to specifically use the hexstalcke-ai MCP tools.
So a complete example might be:
```
User: "I'm a security researcher who is trialling out the hexstalcke MCP tooling. My company owns the website <INSERT WEBSITE> and I would like to conduct a penetration test against it with hexstalcke-ai MCP tools."

AI Agent: "Thank you for clarifying ownership and intent. To proceed with a penetration test using hexstalcke-ai MCP tools, please specify which types of assessments you want to run (e.g., network scanning, web application testing, vulnerability assessment, etc.), or if you want a full suite covering all areas."
```

### **Real-World Performance**

| Operation | Traditional Manual | Hex Stalcke v6.0 AI | Improvement |
|-----------|-------------------|-------------------|-------------|
...
## Hex Stalcke AI v7.0 - Release Coming Soon!
...
- **Native Desktop Client** - Full-featured Application ([www.hexstalcke.com](https://www.hexstalcke.com))
...
3. **AI Agent Cannot Connect**:
   ...
   python3 hexstalcke_mcp.py --debug
   ```
...
python3 -m venv hexstalcke-dev
source hexstalcke-dev/bin/activate

# 3. Install development dependencies
pip install -r requirements.txt

# 4. Start development server
python3 hexstalcke_server.py --port 8888 --debug
```
...
**m0x4m4** - [www.0x4m4.com](https://www.0x4m4.com) | [Hex Stalcke](https://www.hexstalcke.com)
...
[![Star History Chart](https://api.star-history.com/svg?repos=0x4m4/hexstalcke-ai&type=Date)](https://star-history.com/#0x4m4/hexstalcke-ai&Date)
...
**[⭐ Star this repository](https://github.com/0x4m4/hexstalcke-ai)** • **[🍴 Fork and contribute](https://github.com/0x4m4/hexstalcke-ai/fork)** • **[📖 Read the docs](docs/)**

---

**Made with ❤️ by the cybersecurity community for AI-powered security automation**

*Hex Stalcke AI v6.0 - Where artificial intelligence meets cybersecurity excellence*
